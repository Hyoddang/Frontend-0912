...
// valueof()메서드를 사용하여 값을 추출 가능

console.log(f + 1); // 274
console.log(f.valueOf()); // 273

//! 프로토타입으로 메서드 추가
// 숫자 객체 전체에 어떤 속성과 메서드가 추가 가능하다면, 기본 자료형 숫자도 속성과 메서드 사용이 가능
// : 어떤 객체의 prototype이라는 속성이 객체 전용 틀
// : , prototype 객체에 속성과 메서드를 추가하면 모든 객체(+ 기본 자료형)에서 해당 속성과 메서드를 사용 가능

// 객체자료형이름.prototype.메서드명 = function() {
//   
// }
