...
// 참조: 해당 자료의 주소값을 가짐.
// computer1 과 computer2의 두 변수는 같은 객체를 참조하고 있기 때문에 각각의 값을 변경할 시에는 원본 객체도 변경
...
// JS에서는 깊은 복사를 위해 JSON.parse(JSON.stringify(onject)) 를 사용

animal3.name = 'qwerty'
console.log(animal1); // choco
console.log(animal3); // qwerty
