...
//! 1. 객체의 정의
// : 관련된 데이터와 함수의 집합
// : 객체 내부에서는 데이터와 함수를 프로퍼티(속성)와 메서드라고 불림.
...
// 하위 항목: 프로퍼티명, 배열의 일부, 객체의 메서드 등

console.log(person.age); // 속성
console.log(person.interest[1]); // 배열의 일부
// console.log(person.bio()); // 메서드
...
console.log(person.age);
person.age = 45;
person['name']['first'] = 'Hyo';

console.log(person.age) // 45
console.log(person['name']['first']); // Hyo
...
// 두 개의 다른 person 객체가 각각 다른 이름으로 생성될 경우, 호출 시의 해당 객체를 가리킬 때 사용
