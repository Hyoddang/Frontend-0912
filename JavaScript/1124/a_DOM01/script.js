...
document.addEventListener('DOMContentLoaded', () => {
  ...
  a.textContent = '<h2>textContent 속성</h2>'; // 글자 그대로 전달
  b.innerHTML = '<h2>innerHTML 속성</h2>'; // HTML 형식대로 전달
});
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  rects.forEach((rect, index) => {
    ...
    const source = `road-4103334_1280.jpg`
...
document.addEventListener('DOMContentLoaded', () => {
  // container id 속성 아래에 있는 div태그를 선택 (#container > div)
