...
// : 필수적인 요소 X, 생성자가 없는 경우 TS는 빈 생성자를 자동으로 추가
...
// let person1 = new Person(); // 2개의 인수가 필요한데 0개를 가져왔습니다.
let person1 = new Person('Hyo', 27);
console.log(person1.name);
console.log(person1.describe());

let person2 = new Person('Yang', 28);
