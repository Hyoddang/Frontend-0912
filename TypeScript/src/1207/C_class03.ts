...
//* private
// : 해당 클래스 내부에서만 접근 가능
// : 클래스 외부에서 private 멤버에 접근할 경우 오류발생
...
let employee1 = new Employee('Hyo', 50000, 'IT');
...
// : 해당 매개변수는 같은 이름의 속성으로 선언, 해당 매개변수의 인자는 암묵적으로 인스턴스에 할당
class User {
...
let hyo = new User('Hyo', '123');
console.log(`${hyo.id}`);
// console.log(`${hyo.password}`); - 'password' 속성은 private이며 'User' 클래스 내에서만 액세스할 수 있습니다.
