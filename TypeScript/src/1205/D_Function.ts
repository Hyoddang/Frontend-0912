...
console.log(select('Hello', 'Hyo')) // Hyo Hello
...
//? 주의사항
// 선택적 매개변수는 반드시 필수 매개변수 뒤에 작성되어야 한다.
...
function sum(...numbers: number[]): number {
  ...
  // : 네 개의 매개변수를 가질 수 있음.
  // 누적 계산의 결과값: accumlater
  // 처리할 현재 요소: currentValue
  // (선택사항) 처리할 현재 요소의 인덱스
  // (선택사항) reduce를 호출한 배열
  // (선택사항) accumulater의 초기값
...
console.log(greetEveryone('Hyo', 'izi', 'Yang'));
