...
//? 유니언 타입
// 사용자가 string 또는 number 또는 boolean 타입의 데이터를 입력할 수 있는 함수
...
//? 인터섹션 타입
// 타입 속성을 사용하여 User 타입, Permission 타입 정의
// User는 name: string, age: number 속성
// Permissions는 role: string, permissions: string[] 속성
// 두 타입 속성의 인터섹션을 사용하여 EnhancedUser 타입 생성
